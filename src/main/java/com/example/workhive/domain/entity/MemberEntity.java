...
public class MemberEntity {
    ...
    @ManyToOne(fetch = FetchType.LAZY) // 회사와의 다대일 관계 설정
    @JoinColumn(name = "company_id", referencedColumnName = "company_id", nullable = true, foreignKey = @ForeignKey(name = "FK_MEMBER_COMPANY")) // 외래키 설정
